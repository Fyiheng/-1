...
# 导入训练集和测试集
train_data = pd.read_csv(r'C:\Users\lenovo\Downloads\train.csv')
test_data = pd.read_csv(r'C:\Users\lenovo\Downloads\test.csv')
...
sub.to_csv(r'C:\Users\lenovo\Desktop\submission.csv')
